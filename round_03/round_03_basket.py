...
class Trader:
    ...
    def compute_orders_basket(self, order_depth):
        ...
        res_sell = mid_price['GIFT_BASKET'] - mid_price['CHOCOLATE']*4 - mid_price['STRAWBERRIES']*6 - mid_price['ROSES'] - 420
        res_buy = mid_price['CHOCOLATE']*4 + mid_price['STRAWBERRIES']*6 + mid_price['ROSES'] + 420 - mid_price['GIFT_BASKET']
