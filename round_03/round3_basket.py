...
class Trader:
    ...
    begin_diff_dip = -1000000
    begin_diff_bag = -1000000
    begin_bag_price = -1000000
    begin_dip_price = -1000000
    ...
    def compute_orders_basket(self, order_depth):
        ...
        res_buy = mid_price['CHOCOLATE']*4 + mid_price['STRAWBERRIES']*6 + mid_price['ROSES'] + 375 - mid_price['GIFT_BASKET']
